...
// =========================
$addresses = fetch_all('SELECT * FROM address WHERE user_id = ' . (int) $user['id'] . ' ORDER BY is_default DESC, id DESC');
                ...
                <div class="iq-card checkout-card mt-3">
                    <div class="iq-card-body">
                        ...
                        <form method="post" class="mb-3">
                            <div class="mt-2">
                                <a href="add-address.php?return=Checkout-preview.php" class="btn btn-primary">
                                    + Thêm địa chỉ
                                </a>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select name="address_id" class="form-control" onchange="this.form.submit()">
                                    ...
                                    <option value="<?php echo (int) $addr['id']; ?>"
                                        <?php echo ((int) $addr['id'] === $selectedAddressId) ? 'selected' : ''; ?>>
                                        <?php echo h(
                                       $addr['receiver_name'] . ' - ' .
                                       $addr['phone'] . ' - ' .
                                       $addr['address_detail'] . ', ' .
                ...
                <div class="iq-card checkout-card">
                    <div class="iq-card-body">
                        ...
                        <form method="post" id="order-form">
                            ...
                            <div id="bank-form" class="bank-section" style="display:none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bank_number" id="bank_number" class="form-control"
                                        placeholder="Nhập đúng 10 số" autocomplete="off">
                            ...
                            <button class="btn btn-primary btn-soft btn-block-full"
                                <?php echo (!$items || !$address) ? 'disabled' : ''; ?>>
                                Đặt hàng
                            </button>
                        </form>
