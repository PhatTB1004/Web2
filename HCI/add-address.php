...
$returnUrl = $_POST['return'] ?? $_GET['return'] ?? 'profile.php?tab=manage-contact';
...
// Tên người nhận (có hỗ trợ tiếng Việt)
...
elseif (!preg_match('/^[A-Za-zÀ-ỹ\s.-]+$/u', $province)) {
    $error = 'Tỉnh/Thành phố không hợp lệ.';
            ...
            if ($ok) {
    $newAddressId = mysqli_insert_id($db); // lấy ID sau khi insert
    $_SESSION['selected_address_id'] = $newAddressId;
                ...
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        ...
                        <form method="post" action="">
                            ...
                            <a href="<?php echo h($returnUrl); ?>" class="btn btn-secondary">Quay lại</a>
