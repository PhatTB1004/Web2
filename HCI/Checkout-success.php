            ...
            <tbody>
                <?php foreach ($items as $i => $item): ?>
                    <tr>
                        ...
                        <td><?php echo vn_money($item['price'] * $item['quantity']); ?> đ</td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<div class="iq-card mt-3">
    ...
    <div class="iq-card-body">
        <p><strong>Người nhận:</strong> <?php echo h($order['receiver_name']); ?></p>
        <p><strong>SĐT:</strong> <?php echo h($order['receiver_phone']); ?></p>
