                            ...
                            <div class="iq-card-body">
                                <form action="books.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="Jhone Steben">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Giá sách: (đ)</label>
                                        <input type="number" class="form-control" , value="99000">
                                    </div>
                                    <div class="form-group">
                                        <label>Nội dung:</label>
                                        <textarea class="form-control"
                                            rows="4">Cuốn sách đầu tiên của tôi, 'Reading the World'...</textarea>
                                    </div>
