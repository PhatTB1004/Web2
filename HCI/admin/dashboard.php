...
$stats = [
    'users' => fetch_count("SELECT COUNT(*) FROM users WHERE role = 'customer'"),
    'admins' => fetch_count("SELECT COUNT(*) FROM users WHERE role = 'admin'"),
    ...
    'low_stock' => fetch_count('SELECT COUNT(*) FROM books WHERE stock_quantity <= ' . (int) app_setting('inventory_threshold', 5)),
];
      ...
      <div class="col-md-6 col-lg-3">
         <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
            <div class="iq-card-body">
               <h6>Quản trị viên</h6>
               <h2><?php echo number_format($stats['admins']); ?></h2>
            </div>
         </div>
      </div>
      <div class="col-md-6 col-lg-3">
