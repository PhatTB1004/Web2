    ...
    <div class="container-fluid">
        <div class="iq-card mb-4">
            ...
            <div class="iq-card-body">
                <form class="row">
                    <div class="col-md-4 form-group"><label>Tên / mã sách</label><input name="keyword"
                    ...
                    <div class="col-md-3 form-group"><label>Tác giả</label><select name="author_id"
                            class="form-control">
                    ...
                    <div class="col-md-2 form-group align-self-end"><button
        ...
        <div class="mt-3">
            <?php render_pagination($page, $totalPages, ['keyword' => $keyword, 'category_id' => $categoryId, 'author_id' => $authorId]); ?>
        </div>
    </div>
</div>
